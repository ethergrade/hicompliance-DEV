    ...
    return jsonResponse({
      ...
      weekly_snapshot: await (async () => {
        const { data } = await adminClient
          ...
          .select('week_key, week_start_date, tier, total_records, new_records_this_week, risk_index, results_by_source, results_by_filetype, results_by_day, results_by_asset, delta_vs_prev, severity_distribution, computed_at')
          .eq('organization_id', customerId)
