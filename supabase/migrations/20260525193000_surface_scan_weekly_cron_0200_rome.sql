-- SurfaceScan360 weekly schedule alignment
-- Target wall-clock: Monday 02:00 Europe/Rome.
-- This migration keeps the same job name and re-schedules idempotently.
