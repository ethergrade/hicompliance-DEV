...
export function DemoSurfaceScan360() {
  ...
  return <DashboardLayout><div className="space-y-6">
    <SectionNav items={[{ id: "ss-top", label: "Panoramica" }, { id: "ss-kpi", label: "Indicatori" }, { id: "ss-trend", label: "Andamento e copertura" }, { id: "ss-dettaglio", label: "Finding, asset e porte" }]} />
    <header id="ss-top" className="scroll-mt-20 flex flex-col gap-4 border-b border-border pb-5 lg:flex-row lg:items-end lg:justify-between">
    ...
    <div id="ss-kpi" className="scroll-mt-20 grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
    ...
    <div id="ss-trend" className="scroll-mt-20 grid gap-6 lg:grid-cols-[1.4fr_0.6fr]">
    ...
    <Tabs id="ss-dettaglio" defaultValue="findings" className="scroll-mt-20 space-y-4">
