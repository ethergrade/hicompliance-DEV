...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (!token || isTokenExpired()) {
      clearToken();
      setLoading(false);
      if (window.location.pathname !== '/' && window.location.pathname !== '/auth' && !window.location.pathname.startsWith('/hiconsole') && !window.location.pathname.startsWith('/reset-password') && window.location.pathname !== '/saml-callback') {
  ...
  useEffect(() => {
    ...
    if (pathname !== '/' && !pathname.startsWith('/auth') && !pathname.startsWith('/hiconsole') && !pathname.startsWith('/reset-password') && pathname !== '/saml-callback') {
