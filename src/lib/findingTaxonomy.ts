...
const TAXONOMY: Record<string, Omit<FindingTaxonomy, 'owaspLabel'>> = {
  ...
  open_port_exposed:       { cwe: 'CWE-284', owasp: 'A05:2021', baseScore: 5.8, severity: 'medium', category: 'network_exposure' },
  service_fingerprint_exposed: { cwe: 'CWE-200', owasp: 'A05:2021', baseScore: 3.3, severity: 'low', category: 'network_exposure' },
