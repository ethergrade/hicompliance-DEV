...
function isWrappedShodanResponse(value: unknown): value is { data: ShodanScanResponse } {
  return (
    !!value &&
    typeof value === "object" &&
    "data" in value &&
...
export const shodanApi = {
  async scan(
    companyId: string,
    body: { targets?: string[]; rule?: { entry_type: string; input_value: string; ip_start?: string; ip_end?: string } },
    groupId?: string | null,
