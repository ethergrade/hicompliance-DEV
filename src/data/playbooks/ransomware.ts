    ...
    items: [
      {
        ...
        checked: false,
        hasInlineInput: true,
        inlineInputLabel: 'Stato',
        inlineInputValue: '',
        inlineInputPlaceholder: 'Attivo / Contenuto',
      },
      {
        id: 'triage-2',
      ...
      },
      {
        ...
        checked: false,
        hasInlineInput: true,
        inlineInputLabel: 'Backup integro/isolato',
        inlineInputValue: '',
      ...
      },
      {
        ...
        inlineInputValue: '',
        inlineInputPlaceholder: 'P1 / P2 / P3',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        checked: false,
        hasInlineInput: true,
        inlineInputLabel: 'Forensics richiesta',
        inlineInputValue: '',
        inlineInputPlaceholder: 'No / Sì',
      },
      {
      ...
      },
      {
        ...
        checked: false,
        hasInlineInput: true,
        inlineInputLabel: 'Situation Room attivata',
        inlineInputValue: '',
        inlineInputPlaceholder: 'No / Sì',
      },
    ],
    ...
    items: [
      {
        ...
        checked: false,
        hasInlineInput: true,
        inlineInputLabel: 'Notifica CSIRT',
        inlineInputValue: '',
        inlineInputPlaceholder: 'No / Sì',
      },
      {
        ...
        checked: false,
        hasInlineInput: true,
        inlineInputLabel: 'Dati personali esfiltrati',
        inlineInputValue: '',
        inlineInputPlaceholder: 'No / Sì',
      },
      {
        ...
        checked: false,
        hasInlineInput: true,
        inlineInputLabel: 'Comunicazione CdA',
        inlineInputValue: '',
        inlineInputPlaceholder: 'No / Sì',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        checked: false,
        hasInlineInput: true,
        inlineInputLabel: 'Illegittimo sospetto',
        inlineInputValue: '',
        inlineInputPlaceholder: 'No / Sì',
      },
      {
