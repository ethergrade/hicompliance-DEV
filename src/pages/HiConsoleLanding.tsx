...
const modules = [
	{
		...
		bullets: [
			"132 controlli con scoring per area",
			"Snapshot automatici per Gap/Gain Analysis",
			"Report PDF e radar di conformità in tempo reale",
		],
	...
	},
	{
		...
		bullets: [
			"Discovery passiva continua di IP, host e servizi",
			"Enrichment OSINT: CT log, DNSSEC, tech fingerprint",
			"Validazione attiva CVE su autorizzazione esplicita",
		],
	...
	},
	{
		...
		bullets: [
			"Credential leak detection con notifica al titolare",
			"Brand monitoring e typosquatting domain",
			"Indicatori di ransomware e initial-access broker",
		],
...
const irpFeatures = [
	{
		icon: BookOpen,
		title: "Playbook interattivi",
		desc: "Procedure step-by-step per phishing, ransomware, data breach, DDoS, supply-chain. Tracciamento esecuzione, owner per ogni task, evidenze allegate e auto-archiviazione al 100% di completamento.",
	},
	{
		icon: LineChart,
		title: "Analisi rischi & heatmap",
		desc: "33 controlli con matrice impatto/probabilità, mitigazioni colorate (grigio → verde) ed export PDF della heatmap pronta per il board.",
	},
	{
		icon: Network,
		title: "Infrastruttura critica",
		desc: "Wizard per censire asset critici (C-01, C-02...) con dipendenze, RTO/RPO, backup, runbook e dati sensibili trattati. Sincronizzato con le Consistenze.",
	},
	{
		icon: Users,
		title: "Governance & Rubrica",
		desc: "CISO sostituto, ruoli IRP, contatti emergenza e fornitori esterni. Rubrica centralizzata riutilizzata nei playbook.",
	},
	{
		icon: FileCheck,
		title: "Documento IRP esteso",
		desc: "Generazione DOCX dinamica, rubrica azienda e rubrica fornitori, classificazione NIS2, asset critici, playbook, allegati.",
	},
	{
		icon: Siren,
		title: "Eventi compliance",
		desc: "Log temporale degli eventi (incident, esercitazioni, audit) con archiviazione automatica dei playbook eseguiti e tracciabilità completa.",
	},
];
...
const hiSolutionServices = [
	...
	{ icon: Search, name: "HiDetect", desc: "Detection & response 24/7" },
	{
		icon: Smartphone,
		name: "HiMobile",
		desc: "MDM e protezione dispositivi mobili",
	},
];
			...
			<section className="container mx-auto px-4 pt-16 pb-10 md:pt-20 md:pb-12">
				<div className="max-w-4xl mx-auto text-center space-y-6">
					...
					<p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
						<strong>HiSolution Console</strong> è la piattaforma unificata
						HiSolution per gestire la serenità tecnologica. IT e cybersecurity:
						assessment normativi, monitoraggio della superficie d'attacco,
						threat intelligence sul dark web, risposta agli incidenti,
						remediation pianificata con budget, Endpoint e Firewall Dashboard,
						monitoraggio dei dispositivi, patch e log management, SIEM/SOAR con
						PowerQuery semplificato. <strong>Tutto in un unico posto.</strong>
					</p>
			...
			<section id="moduli" className="container mx-auto px-4 pt-10 pb-16">
				<div className="text-center mb-12 space-y-3">
					<Badge variant="secondary" className="text-sm px-3 py-1">
						I moduli integrabili
					</Badge>
					<h2 className="text-3xl md:text-5xl font-bold">
						I moduli che puoi attivare
					</h2>
					<p className="text-muted-foreground max-w-2xl mx-auto text-lg">
						Attivi solo quello che ti serve, modulo per modulo e cliente per
				...
				<div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
					{modules.map((m) => (
						...
						>
							<div
								className={`absolute inset-0 bg-gradient-to-br ${m.color} opacity-50`}
							/>
						...
						<CardContent className="relative p-8 grid md:grid-cols-[auto_1fr_auto] gap-6 items-center">
							...
							<div className="space-y-2">
								...
								<p className="text-sm text-muted-foreground leading-relaxed max-w-3xl">
									Trasforma findings e gap di compliance in un{" "}
									<strong>piano operativo con tempi, owner e costi</strong>.
									Ogni intervento ha priorità, effort stimato, budget allocato e
									stato avanzamento. Vedi a colpo d'occhio quanto stai
									investendo, quanto rischio stai abbattendo e a che punto sei
								...
								<ul className="grid sm:grid-cols-2 gap-x-6 gap-y-1.5 text-sm pt-1">
									<li className="flex items-start gap-2">
										...
										<span>Roadmap con milestone trimestrali</span>
									</li>
									<li className="flex items-start gap-2">
										<Wallet className="w-4 h-4 text-amber-500 mt-0.5 shrink-0" />
										<span>Budget per intervento: previsto / consuntivo</span>
									</li>
									<li className="flex items-start gap-2">
										<Target className="w-4 h-4 text-amber-500 mt-0.5 shrink-0" />
										<span>Linking automatico a findings, CVE e gap NIS2</span>
									</li>
									<li className="flex items-start gap-2">
										<TrendingUp className="w-4 h-4 text-amber-500 mt-0.5 shrink-0" />
										<span>Impatto stimato sul True Risk Score</span>
									</li>
								</ul>
							</div>
				...
				<div className="max-w-6xl mx-auto mt-10">
					<div className="flex items-center gap-3 mb-6">
						...
						<Badge variant="secondary" className="shrink-0">
							Servizi HiSolution collegabili
						</Badge>
						<div className="h-px flex-1 bg-border/60" />
					</div>
					<div className="text-center mb-6 space-y-1">
						<h3 className="text-xl font-semibold">
							Integra l'intero ecosistema HiSolution
						</h3>
						<p className="text-sm text-muted-foreground max-w-2xl mx-auto">
							Collega i servizi gestiti alla console: stato in tempo reale,
							metriche, alert e correlazione log — tutto sotto un unico tetto.
						</p>
					</div>
					<div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
						{hiSolutionServices.map((s) => (
							<Card
								key={s.name}
								className="relative overflow-hidden border-border/50 hover:border-primary/40 transition-colors group"
							>
						...
						<CardContent className="relative p-10 grid md:grid-cols-[1fr_auto] gap-10 items-center">
							<div className="space-y-5">
								...
								<p className="text-muted-foreground leading-relaxed">
									Il <strong>True Risk Score</strong> è l'unico indice sintetico
									della piattaforma: un valore <strong>0–100</strong> che
									combina in un solo numero tutto ciò che conta — postura di
									compliance, superficie d'attacco, esposizione su dark web,
									maturità IRP e copertura dei servizi gestiti. Niente cruscotti
									contraddittori, niente metriche slegate: una sola verità,
									aggiornata ad ogni assessment, scan e alert.
								</p>
								<ul className="grid sm:grid-cols-2 gap-x-6 gap-y-2 text-sm">
									<li className="flex items-start gap-2">
										<CheckCircle2 className="w-4 h-4 text-primary mt-0.5 shrink-0" />
										<span>
											Pesato su criticità asset e classificazione NIS2
										</span>
									</li>
									<li className="flex items-start gap-2">
										<CheckCircle2 className="w-4 h-4 text-primary mt-0.5 shrink-0" />
										<span>Aggiornato in tempo reale dai moduli attivi</span>
									</li>
									<li className="flex items-start gap-2">
										<CheckCircle2 className="w-4 h-4 text-primary mt-0.5 shrink-0" />
										<span>Storico trend per dimostrare il miglioramento</span>
									</li>
									<li className="flex items-start gap-2">
										<CheckCircle2 className="w-4 h-4 text-primary mt-0.5 shrink-0" />
										<span>
											Simulazione "what-if" sugli interventi in roadmap
										</span>
									</li>
								</ul>
								<p className="text-xs text-muted-foreground italic pt-1">
									Attiva il modulo <strong>HiCompliance</strong> per sbloccare
									il True Risk Score: l'assessment iniziale crea la base, mentre
									gli altri moduli lo mantengono aggiornato in tempo reale.
								</p>
							</div>
								...
								<div className="relative w-56 h-56 rounded-full bg-gradient-to-br from-primary/30 to-primary/5 border-4 border-primary/40 flex items-center justify-center shadow-2xl shadow-primary/20">
									<div className="absolute inset-3 rounded-full bg-background/60 backdrop-blur flex flex-col items-center justify-center">
										...
										<div className="text-[10px] text-red-500 mt-1 flex items-center gap-1">
											<TrendingUp className="w-3 h-3" /> Aggiornato in tempo
											reale
										</div>
									</div>
								</div>
				...
				<div className="max-w-6xl mx-auto">
					<div className="grid md:grid-cols-2 gap-12 items-start">
						<div className="space-y-5">
							...
							<p className="text-muted-foreground leading-relaxed">
								L'<strong>Incident Response Plan</strong> di HiSolution Console
								non è un documento PDF da aggiornare ogni due anni: è un sistema
								vivo, integrato con la tua infrastruttura e il tuo team. Quando
								scatta un incidente, il responsabile apre il playbook giusto,
								segue gli step, assegna i task ai responsabili nominati nella
								rubrica, allega evidenze e screenshot, e a fine procedura
								ottiene automaticamente il documento archiviabile sia per ACN
								che per l'autorità di controllo.
							</p>
							<p className="text-muted-foreground leading-relaxed">
								Tutto è già pre-popolato per <strong>NIS2</strong>:
								classificazione del soggetto, CISO sostituto, asset critici,
								fornitori essenziali. Tu pensi al business, il piano evolve con
								te.
							</p>
							<Link to="/auth?role=admin">
								<Button>
        ...
        `}</style>
				<div className="container mx-auto px-4 text-center mb-10 space-y-3">
					...
					<p className="text-muted-foreground max-w-2xl mx-auto text-sm leading-relaxed">
						HiSolution Console orchestra i principali vendor di cybersecurity e
						IT service management: Sophos, BitDefender, ESET, Fortinet,
						Darktrace, Domotz, ServiceNow e altri. Un'unica piattaforma per
						leggere lo stato reale di tutte le protezioni dei tuoi clienti.
					</p>
				</div>
				...
				<Card className="max-w-4xl mx-auto border-primary/30 bg-gradient-to-br from-primary/10 via-background to-background">
					<CardContent className="p-10 text-center space-y-5">
						...
						<h2 className="text-3xl font-bold">
							Serenità tecnologica, in una sola login.
						</h2>
						<p className="text-muted-foreground max-w-xl mx-auto">
							Accedi a HiSolution Console per orchestrare compliance, attack
							surface, dark web monitoring, incident response, remediation
							pianificata e i servizi HiSolution dei tuoi clienti.
						</p>
			...
			<footer className="border-t border-border/40 py-8">
				<div className="container mx-auto px-4 text-center text-xs text-muted-foreground">
					© {new Date().getFullYear()} HiCompliance · HiSolution Console —
					Piattaforma per la serenità tecnologica
				</div>
			</footer>
		</div>
	);
