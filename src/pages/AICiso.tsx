...
const AICiso: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <div className="h-[calc(100vh-6rem)] flex bg-slate-950 rounded-lg overflow-hidden relative border border-slate-800/60">
        <StarfieldBackground />

        {/* Conversation history sidebar */}
        <div className="w-56 border-r border-slate-800/60 bg-slate-950/80 backdrop-blur-sm z-10 flex-shrink-0">
                ...
                <div className="h-full flex flex-col items-center justify-center space-y-8">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-slate-500 max-w-md">
                      Analizza la postura di sicurezza, identifica rischi e genera remediation prioritizzate.
                    </p>
                  </div>
