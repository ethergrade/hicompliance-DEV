...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-gradient-to-br from-background via-background to-muted/30">
        <div className="container mx-auto px-4 text-center py-[15px]">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            <span className="text-white">HiConsole:</span>
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            HiConsole offre una soluzione completa per la gestione del rischio cyber, 
      ...
      <section className="py-20 bg-muted/30 text-center">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Servizi HiConsole Integrati</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Monitoraggio centralizzato di tutti i servizi di sicurezza HiConsole 
      ...
      <section id="valutazione-nis2" className="py-20 bg-gradient-cyber">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">Scopri HiConsole per iniziare la valutazione della conformità e proteggere la tua organizzazione dalle minacce cyber.</p>
          {showAuthenticatedHeader ? <Link to="/dashboard">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <p className="text-muted-foreground text-sm">
              © 2025 HiConsole un Servizio Gestito - Gestione Cyber Risk per la serenità tecnologica.
            </p>
          </div>
        </div>
      </footer>
